    ...
    <div className="">
      ...
      <div className="flex flex-col gap-5">
        {events.map((event) => (
          <div
            key={event._id}
            className="grid grid-cols-1 md:grid-cols-3 bg-white rounded-sm md:gap-10 border border-gray-300"
          >
            ...
            <div className="col-span-2 flex flex-col gap-5 justify-between p-5">
              ...
              <p className="text-gray-500 overflow-ellipsis overflow-hidden line-clamp-3 text-sm">
                {event.description}
              </p>
