  ...
  const getProperty = ({ key, value }: { key: string; value: any }) => {
    return (
      <div>
        ...
        <h1 className="text-gray-700 text-sm overflow-hidden overflow-ellipsis">
          {value}
        </h1>
      </div>
    );
      ...
      <div className="flex flex-col gap-5 mt-5">
        {bookedEvents.map((booking) => {
          return (
            ...
            >
              <div className="bg-gray-700 p-3 text-white flex flex-col md:flex-row justify-between md:items-center">
                <div className="w-full">
                  <h1 className="text-xl md:text-2xl font-semibold">
                    {booking.event.name}
                  </h1>
                  <div className="text-sm flex flex-col md:flex-row gap-1 md:gap-10 text-gray-200">
                    <h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-5 p-3">
                ...
                {getProperty({
                  key: "Booked On",
                  value: dayjs(booking.createdAt).format("YYYY/MM/DD HH:mm"),
                })}
                {getProperty({
                  key: "Status",
